...
function RouletteWheel({ isSpinning, onSpinEnd }: RouletteWheelProps) {
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div
        className={`relative h-72 w-72 rounded-full border-4 border-black ${
      ...
      >
        ...
        <div className="absolute inset-[102px] rounded-full border-4 border-black bg-[#D6FF00]" />
        <div className="absolute inset-[118px] rounded-full border-2 border-black bg-white" />
      </div>
